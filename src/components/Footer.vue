<template>
  <b-navbar
    id="idFooter"
    class="w-100"
    style="width: 100%!imporant; border-top: 4px solid #ce3333 !important"
  >
    <b-collapse id="nav-collapse mr-1" is-nav>
      <b-navbar-nav id="navegadorFooter" class="text-center">
        <b-link
          class="menuFooter"
          href="https://www.facebook.com"
          target="_blank"
        >
          <i class="bi bi-facebook iconsFooter"></i>
        </b-link>
        <b-link
          class="menuFooter"
          ...
          target="_blank"
        >
          <i class="bi bi-instagram iconsFooter"></i>
        </b-link>
        <b-link class="menuFooter">
          <i class="bi bi-whatsapp iconsFooter"></i>
        </b-link>
      </b-navbar-nav>
    </b-collapse>
    <div
      ...
      "
    >
      <i class="bi bi-telephone-fill iconsFooter"></i>
      <p
        style="
